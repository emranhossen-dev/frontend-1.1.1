...
export default function CategoryPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  // Filter & Sort Logic — pre-filtered by the slug category
      ...
      <main className="flex-1 max-w-7xl mx-auto w-full px-4 py-4 pb-12">
        ...
        {isLoading ? (
          ...
          <div className="py-16 text-center space-y-4">
            ...
            <p className="text-gray-700 dark:text-gray-300 text-base font-bold">
              &quot;{categoryDisplayName}&quot; — এই ক্যাটাগরিতে এখনো কোনো প্রোডাক্ট নেই।
            </p>
            <p className="text-gray-500 text-sm">আমাদের সকল প্রোডাক্ট দেখতে All Products-এ যান।</p>
            <Link
              href="/products"
              className="inline-block px-6 py-2 bg-black dark:bg-white text-white dark:text-black font-bold text-xs rounded-xl"
            >
              সব প্রোডাক্ট দেখুন
            </Link>
          </div>
        ...
        {isFilterOpen && (
          <div className="fixed inset-0 z-50 overflow-hidden flex items-end justify-center">
            ...
            />
            <div className="relative w-full max-w-lg bg-white dark:bg-slate-900 rounded-t-3xl shadow-2xl max-h-[85vh] flex flex-col justify-between p-6 space-y-5 z-10 overflow-y-auto border-t border-gray-200 dark:border-slate-800">
              ...
              <div className="space-y-5">
                ...
                <div className="space-y-2">
                  <label className="text-xs font-bold uppercase tracking-wider text-gray-400">All Categories</label>
                ...
                <div className="space-y-2 pt-3 border-t border-gray-100 dark:border-slate-800">
                  <div className="flex justify-between text-xs font-bold">
                    ...
                    <span className="text-gray-900 dark:text-white">{storeConfig.currency}{maxPrice.toLocaleString()}</span>
                  </div>
                  <input
              ...
              <div className="pt-3 border-t border-gray-200 dark:border-slate-800 flex gap-2">
                <button
                  onClick={() => { setMaxPrice(20000); setSortBy('featured'); setIsFilterOpen(false); }}

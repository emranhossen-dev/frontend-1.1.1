...
export const HeroSection: React.FC<HeroSectionProps> = ({ banner }) => {
  const slides = [
    {
      badge: banner?.badge || 'স্মার্ট গ্যাজেট কালেকশন ⚡',
      title: banner?.title || 'স্মার্ট এলইডি ডিজিটাল পেন হোল্ডার',
      subtitle: banner?.subtitle || 'ডিজিটাল ঘড়ি, আলার্ম ও নাইট লাইটসহ প্রিমিয়াম ডেক্স অর্গানাইজার। আপনার ডেক্সকে দিন আধুনিক লুক!',
      imageUrl: banner?.imageUrl || '/images/ardhimart-smart-pen-holder.webp',
      ctaPrimaryText: banner?.ctaPrimaryText || 'এখনই অর্ডার করুন',
      ctaPrimaryLink: banner?.ctaPrimaryLink || '/products',
      ctaSecondaryText: banner?.ctaSecondaryText || 'গ্যাজেটসমূহ দেখুন',
      ctaSecondaryLink: banner?.ctaSecondaryLink || '/products',
    },
    {
      badge: 'মেগা গিফট কালেকশন 🎁',
      title: 'প্রিয়জনের জন্য সারপ্রাইজ গিফট বক্স',
      subtitle: 'বার্থডে, এনিভার্সারি বা বিশেষ মুহূর্তে প্রিয়জনকে দিন সেরা সারপ্রাইজ গিফট কম্বো!',
      imageUrl: '/images/ardhimart-giftbox-valentine-set.webp',
      ctaPrimaryText: 'গিফট কম্বো দেখুন',
      ctaPrimaryLink: '/products',
      ctaSecondaryText: 'অফার ভাউচার পান',
      ctaSecondaryLink: '/products',
    },
    {
      badge: 'এক্সক্লুসিভ গিফট ডিলস 🌟',
      title: 'ইউনিক গিফট ও ট্রেন্ডিং ডেকোর আইটেম',
      subtitle: 'আর্টিফিশিয়াল ফ্লাওয়ার ডোম, কিউট ডল এবং ট্রেন্ডিং ডেকোরেশন আইটেমে বিশেষ ছাড়!',
      imageUrl: '/images/ardhimart-giftbox-set.webp',
      ctaPrimaryText: 'কালেকশন দেখুন',
      ctaPrimaryLink: '/products',
      ctaSecondaryText: 'সব প্রোডাক্টস',
      ctaSecondaryLink: '/products',
    },
  ];

    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          a: 'যদি প্রোডাক্টের ছবি এবং বর্ণনার সাথে বাস্তবের প্রোডাক্টের মিল না থাকে, তবে আপনি ৭ দিনের রিটার্ন পলিসির আওতায় এটি পরিবর্তন করতে পারবেন। তবে শুধুমাত্র পছন্দ হয়নি, এমন কারণে রিটার্ন গ্রহণযোগ্য নয়।',
        },
        {
